...
$(builddir)/metricAnalyzer.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/metricAnalyzer.node: LIBS := $(LIBS)
$(builddir)/metricAnalyzer.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/metricAnalyzer.node: TOOLSET := $(TOOLSET)
$(builddir)/metricAnalyzer.node: $(OBJS) FORCE_DO_CMD
...
metricAnalyzer.node: $(builddir)/metricAnalyzer.node
