...
angular.module('community').controller('CommunityController', ['$scope', '$routeParams', '$location', 'Community', function ($scope, $routeParams, $location, Projects) {

    //Create a new controller method for creating new articles
    $scope.create = function () {
        // Use the form fields to create a new article $resource object
        var user = new Community({
...
//# sourceMappingURL=community.client.controller-compiled.js.map