...
angular.module('projects').controller('ProjectsController', ['$scope', '$routeParams', '$location', 'Projects', '$compile', function ($scope, $routeParams, $location, Projects, $compile) {
    ...
    $scope.clickFile = function (file) {
        ...
        var sourceContainer = angular.element(document.querySelector('#fileSource'));
