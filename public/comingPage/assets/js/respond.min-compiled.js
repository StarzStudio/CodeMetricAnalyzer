...
(function (a) {
  ...
  function x() {
    u(!0);
  }var b = {};a.respond = b, b.update = function () {}, b.mediaQueriesSupported = a.matchMedia && a.matchMedia("only all").matches, b.mediaQueriesSupported;var q,
      r,
      t,
      c = a.document,
      d = c.documentElement,
    ...
    for (var b = 0; l.length > b; b++) {
      ...
      o = function o() {
    if (m.length) {
      var a = m.shift();v(a.href, function (b) {
    ...
    var b = "clientWidth",
        ...
        m = {},
        n = l[l.length - 1],
        o = new Date().getTime();if (a && q && i > o - q) return clearTimeout(r), r = setTimeout(u, i), void 0;q = o;for (var p in e) {
      if (e.hasOwnProperty(p)) {
        var v = e[p],
            ...
            y = null === w,
            z = null === x,
            A = "em";w && (w = parseFloat(w) * (w.indexOf(A) > -1 ? t || s() : 1)), x && (x = parseFloat(x) * (x.indexOf(A) > -1 ? t || s() : 1)), v.hasquery && (y && z || !(y || k >= w) || !(z || x >= k)) || (m[v.media] || (m[v.media] = []), m[v.media].push(f[v.rules]));
      }
    }for (var B in g) {
