...
define(function (require, exports, module) {
    ...
    module.exports = {
        ...
        "test simple snippet": function testSimpleSnippet(next) {
        ...
        "test theme classname should be in output html": function testThemeClassnameShouldBeInOutputHtml(next) {
            var theme = require("../theme/tomorrow");
            var snippet = ["/** this is a function", "*", "*/", "function hello (a, b, c) {", "    console.log(a * b + c + 'sup?');", "}"].join("\n");
            var mode = new JavaScriptMode();
        ...
        "test js string replace specials": function testJsStringReplaceSpecials(next) {
            var theme = require("../theme/tomorrow");
            var snippet = "$'$1$2$$$&";
...
//# sourceMappingURL=static_highlight_test-compiled.js.map